...
#ifdef REGION_US915_HELIUM
#include "RegionUS915-helium.h"
#define US915_HELIUM_CASE                                 case LORAMAC_REGION_US915_HELIUM:
#define US915_HELIUM_IS_ACTIVE( )                         US915_HELIUM_CASE { return true; }
#define US915_HELIUM_GET_PHY_PARAM( )                     US915_HELIUM_CASE { return RegionUS915HeliumGetPhyParam( getPhy ); }
#define US915_HELIUM_SET_BAND_TX_DONE( )                  US915_HELIUM_CASE { RegionUS915HeliumSetBandTxDone( txDone ); break; }
#define US915_HELIUM_INIT_DEFAULTS( )                     US915_HELIUM_CASE { RegionUS915HeliumInitDefaults( params ); break; }
#define US915_HELIUM_VERIFY( )                            US915_HELIUM_CASE { return RegionUS915HeliumVerify( verify, phyAttribute ); }
#define US915_HELIUM_APPLY_CF_LIST( )                     US915_HELIUM_CASE { RegionUS915HeliumApplyCFList( applyCFList ); break; }
#define US915_HELIUM_CHAN_MASK_SET( )                     US915_HELIUM_CASE { return RegionUS915HeliumChanMaskSet( chanMaskSet ); }
#define US915_HELIUM_COMPUTE_RX_WINDOW_PARAMETERS( )      US915_HELIUM_CASE { RegionUS915HeliumComputeRxWindowParameters( datarate, minRxSymbols, rxError, rxConfigParams ); break; }
#define US915_HELIUM_RX_CONFIG( )                         US915_HELIUM_CASE { return RegionUS915HeliumRxConfig( rxConfig, datarate ); }
#define US915_HELIUM_TX_CONFIG( )                         US915_HELIUM_CASE { return RegionUS915HeliumTxConfig( txConfig, txPower, txTimeOnAir ); }
#define US915_HELIUM_LINK_ADR_REQ( )                      US915_HELIUM_CASE { return RegionUS915HeliumLinkAdrReq( linkAdrReq, drOut, txPowOut, nbRepOut, nbBytesParsed ); }
#define US915_HELIUM_RX_PARAM_SETUP_REQ( )                US915_HELIUM_CASE { return RegionUS915HeliumRxParamSetupReq( rxParamSetupReq ); }
#define US915_HELIUM_NEW_CHANNEL_REQ( )                   US915_HELIUM_CASE { return RegionUS915HeliumNewChannelReq( newChannelReq ); }
#define US915_HELIUM_TX_PARAM_SETUP_REQ( )                US915_HELIUM_CASE { return RegionUS915HeliumTxParamSetupReq( txParamSetupReq ); }
#define US915_HELIUM_DL_CHANNEL_REQ( )                    US915_HELIUM_CASE { return RegionUS915HeliumDlChannelReq( dlChannelReq ); }
#define US915_HELIUM_ALTERNATE_DR( )                      US915_HELIUM_CASE { return RegionUS915HeliumAlternateDr( currentDr, type ); }
#define US915_HELIUM_NEXT_CHANNEL( )                      US915_HELIUM_CASE { return RegionUS915HeliumNextChannel( nextChanParams, channel, time, aggregatedTimeOff ); }
#define US915_HELIUM_CHANNEL_ADD( )                       US915_HELIUM_CASE { return RegionUS915HeliumChannelAdd( channelAdd ); }
#define US915_HELIUM_CHANNEL_REMOVE( )                    US915_HELIUM_CASE { return RegionUS915HeliumChannelsRemove( channelRemove ); }
#define US915_HELIUM_SET_CONTINUOUS_WAVE( )               US915_HELIUM_CASE { RegionUS915HeliumSetContinuousWave( continuousWave ); break; }
#define US915_HELIUM_APPLY_DR_OFFSET( )                   US915_HELIUM_CASE { return RegionUS915HeliumApplyDrOffset( downlinkDwellTime, dr, drOffset ); }
#define US915_HELIUM_RX_BEACON_SETUP( )                   US915_HELIUM_CASE { RegionUS915HeliumRxBeaconSetup( rxBeaconSetup, outDr ); break; }
#else
#define US915_HELIUM_IS_ACTIVE( )
#define US915_HELIUM_GET_PHY_PARAM( )
#define US915_HELIUM_SET_BAND_TX_DONE( )
#define US915_HELIUM_INIT_DEFAULTS( )
#define US915_HELIUM_GET_NVM_CTX( )
#define US915_HELIUM_VERIFY( )
#define US915_HELIUM_APPLY_CF_LIST( )
#define US915_HELIUM_CHAN_MASK_SET( )
#define US915_HELIUM_COMPUTE_RX_WINDOW_PARAMETERS( )
#define US915_HELIUM_RX_CONFIG( )
#define US915_HELIUM_TX_CONFIG( )
#define US915_HELIUM_LINK_ADR_REQ( )
#define US915_HELIUM_RX_PARAM_SETUP_REQ( )
#define US915_HELIUM_NEW_CHANNEL_REQ( )
#define US915_HELIUM_TX_PARAM_SETUP_REQ( )
#define US915_HELIUM_DL_CHANNEL_REQ( )
#define US915_HELIUM_ALTERNATE_DR( )
#define US915_HELIUM_NEXT_CHANNEL( )
#define US915_HELIUM_CHANNEL_ADD( )
#define US915_HELIUM_CHANNEL_REMOVE( )
#define US915_HELIUM_SET_CONTINUOUS_WAVE( )
#define US915_HELIUM_APPLY_DR_OFFSET( )
#define US915_HELIUM_RX_BEACON_SETUP( )
#endif
